...
public class BaseRevisionTestConfig extends BaseTestCase{
    ...
    public CommandLineRunner initRevisionOfADDType() {
        return args -> {
            ...
            Member kjh = Member.newMember("kjh", "pa$$word", web1);
            Member lsy = Member.newMember("lsy", "pa$$word", web1);
            Member jts = Member.newMember("jts", "pa$$word", web2);
            ...
            Member applyMember1 = Member.newMember("applyMember1", "pa$$word", web2);
            Member applyMember2 = Member.newMember("applyMember2", "pa$$word", web2);
    ...
    public CommandLineRunner initRevisionOfMODType() {
        return args -> {
            ...
            allMember.forEach(member -> member.changePassword("password"));
            memberRepository.saveAll(allMember);
        };
    }
